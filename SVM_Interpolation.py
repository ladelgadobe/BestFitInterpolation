...
def _prepare_feature_matrices(points_df, grid_df, target_column, covariate_columns, x_col="x", y_col="y"):
    ...
    train_columns = [x_col, y_col, target_column] + list(covariate_columns)
    predict_columns = [x_col, y_col] + list(covariate_columns)
    ...
    X_train = train_df[[x_col, y_col] + list(covariate_columns)].to_numpy(dtype=float)
    y_train = train_df[target_column].to_numpy(dtype=float)
    X_pred = pred_df[[x_col, y_col] + list(covariate_columns)].to_numpy(dtype=float)

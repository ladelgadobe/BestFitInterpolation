...
def tps_interpolation(x, y, z, xi, yi, epsilon=None, chunk_size=50000):
    ...
    epsilon : float or None, optional
        ...
        Note: We intentionally do NOT expose/optimize epsilon here.
    ...
    Notes
    -----
    - This function is designed to plug directly into the QGIS plugin.
    - Uses Rbf(function='thin_plate'). For pure interpolation, smoothing is 0.
    ...
    # Fit RBF TPS once
    # smooth=0 for interpolation; function='thin_plate' for TPS kernel
    rbf = Rbf(x, y, z, function='thin_plate', epsilon=float(epsilon), smooth=0.0)

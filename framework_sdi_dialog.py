...
class FrameworkSDIDialog(QDialog):
    ...
    def _build_ui(self) -> None:
        ...
        self.cmb_model.addItems(["Spherical", "Exponential", "Gaussian"])
    ...
    def _seed_defaults(self) -> None:
        ...
        self._updating = True
        try:
            self.cmb_model.setCurrentText(seeded_model if self.cmb_model.findText(seeded_model) >= 0 else "Spherical")
    ...
    def _should_use_reml(self) -> bool:
        ...
        return bool(_HAS_REML and fit_ok_reml_interface is not None and n < 100)
    ...
    def _run_reml_mode(self, x: np.ndarray, y: np.ndarray, z: np.ndarray) -> None:
        ...
        model_txt = self.cmb_model.currentText()
